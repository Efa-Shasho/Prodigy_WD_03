...
let box_array=[box1,box2,box3,box4,box5,box6,box7,box8,box9 ];
  ...
  const toggle=(e,num)=>{
    ...
    if (count % 2 === 0) {
      e.target.innerHTML = `<img src="${x}" alt="" />`;
      data[num] = "x";
      setCount(++count);
    } else {
...
if(winner="x")
  {
titleRef.current.innerHTML=`Congratulations <img src=${x} alt="" />`
}
else{
...
const reset=()=>{
  setLock(false);
  data=["","","","","","","","",""];
  titleRef.current.innerHTML='Tic Tac Toe <spa>React</spa'
box_array.map((e)=>{
  e.current.innerHTML="";
})
}
  return (
    <div className='container'>
      ...
      <h1 className='title' ref={titleRef}><span>ROYAL </span> <br/>Tic Tac Toe   </h1>
      <div className='board'>
<div className="row1">
